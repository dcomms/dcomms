    ...
    public partial class ConnectionToNeighbor: IDisposable, IVisibleModule, IVisiblePeer
    {
     ...
     //   IirFilterCounter TxInviteRateRps, TxRegisterRateRps;
      ...
      //  List<TxInviteRequestState> PendingTxInviteRequests;
        ...
        public float[] VectorValues => RegistrationIdDistance.GetVectorValues(_localDrpPeer.CryptoLibrary, _remoteRegistrationId).Select(x => (float)x).ToArray();
        public bool Highlighted => false;
        public IEnumerable<IVisiblePeer> NeighborPeers => null;
...
_retry:
        ...
        public string GetDistanceString(IVisiblePeer toThisPeer)
        {
