...
namespace Dcomms.MessengerA.Droid
{
    ...
    public class MainService : Service
    {
        ...
        static List<Action<UserAppEngine, VisionChannel1>> _startServiceCallbacks = new List<Action<UserAppEngine, VisionChannel1>>();
        public static void StartService(Context context, Action<UserAppEngine, VisionChannel1> cb = null)
        {

            if (_userAppEngine != null) cb?.Invoke(_userAppEngine, _visionChannel);
            else
            {
